...
return array(
    ...
    'classify' => array('after_add', 'after_edit', 'after_get'),
    'cache' => array('after_add', 'after_edit', 'after_delete', 'after_remove', 'after_restore', 'after_bumpup', 'after_unpublish', 'after_pass', 'after_publish'),
);