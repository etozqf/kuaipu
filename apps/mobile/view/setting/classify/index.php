...
<div class="mar_l_8 mar_r_8" style="width: 900px;">
    <div class="list-header">
        ...
        <select id="changestatus" style="width:60px">
                <option value="0" <?php if($modelid == 0):?>checked="checked"<?php endif;?>>全部</option>
                <?php
    ...
    $(function() {
        ...
        window.MobileClassIfy = {
            ...
            sort:function(oldIndex, newIndex) {
                var modelid = $('#changestatus').val();
                $.post("?app=mobile&controller=setting&action=classify_updown&modelid="+modelid, {
                    classifyid: this.attr('data-catid'),
                    old: oldIndex,
                    now: newIndex
                });
            }
        ...
        $('#changestatus').change(function(){
            ...
            tableApp.load('modelid='+modelid);
            if (modelid != 0) {
                TableSortable($('#item_list'), 1, 1, 2, MobileClassIfy.sort);
            } else {
                TableSortable();
            }
        });
