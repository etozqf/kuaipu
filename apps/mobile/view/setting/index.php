...
<form id="setting_index" action="?app=mobile&controller=setting&action=index" method="POST" class="validator">
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
        ...
        <tr>
            <th>天气背景图：</th>
            <td id="weather_background"><?php echo element::image("config[weather_background]", $setting['weather_background'], 20, 1);?></td>
        </tr>
    </table>
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
        ...
        <?php endif; ?>
        <!--<tr>
            <th width="160">登陆后完善资料：</th>
            <td>
                <label><input type="radio" name="config[isfilldata]" value="1" <?/*=form_element::checked($setting['isfilldata'])*/?> /> 需要</label>
                <label><input type="radio" name="config[isfilldata]" value="0" <?/*=form_element::checked(!$setting['isfilldata'])*/?> /> 不需要</label>
            </td>
        </tr>-->
    </table>
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
        <caption>手机登陆设置</caption>
        <tr>
            <th width="160">微信登陆：</th>
            <td>
                <label class="issecret" type="weixitimeline"><input type="radio" name="config[login][mobile][weixitimeline]" value="1"<?=form_element::checked($setting['login']['mobile']['weixitimeline'])?> <?php if(!$setting['api']['weixitimeline']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][mobile][weixitimeline]" value="0"<?=form_element::checked(!$setting['login']['mobile']['weixitimeline'])?> /> 关闭</label>
            </td>
        </tr>
        <tr>
            <th width="160">QQ登陆：</th>
            <td>
                <label class="issecret" type="qq"><input type="radio" name="config[login][mobile][qq]" value="1"<?=form_element::checked($setting['login']['mobile']['qq'])?>  <?php if(!$setting['api']['qq']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][mobile][qq]" value="0"<?=form_element::checked(!$setting['login']['mobile']['qq'])?> /> 关闭</label>
            </td>
        </tr>
        <tr>
            <th width="160">微博登陆：</th>
            <td>
                <label class="issecret" type="sinaweibo_android"><input type="radio" name="config[login][mobile][sinaweibo_android]" value="1"<?=form_element::checked($setting['login']['mobile']['sinaweibo_android'])?> <?php if(!$setting['api']['sinaweibo_android']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][mobile][sinaweibo_android]" value="0"<?=form_element::checked(!$setting['login']['mobile']['sinaweibo_android'])?> /> 关闭</label>
            </td>
        </tr>
    </table>
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
        <caption>平板登陆设置</caption>
        <tr>
            <th width="160">微信登陆：</th>
            <td>
                <label class="issecret" type="weixitimeline"><input type="radio" name="config[login][pad][weixitimeline]" value="1"<?=form_element::checked($setting['login']['pad']['weixitimeline'])?> <?php if(!$setting['api']['weixitimeline']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][pad][weixitimeline]" value="0"<?=form_element::checked(!$setting['login']['pad']['weixitimeline'])?> /> 关闭</label>
            </td>
        </tr>
        <tr>
            <th width="160">QQ登陆：</th>
            <td>
                <label class="issecret" type="qq"><input type="radio" name="config[login][pad][qq]" value="1"<?=form_element::checked($setting['login']['pad']['qq'])?> <?php if(!$setting['api']['qq']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][pad][qq]" value="0"<?=form_element::checked(!$setting['login']['pad']['qq'])?> /> 关闭</label>
            </td>
        </tr>
        <tr>
            <th width="160">微博登陆：</th>
            <td>
                <label class="issecret" type="sinaweibo_pad"><input type="radio" name="config[login][pad][sinaweibo_pad]" value="1"<?=form_element::checked($setting['login']['pad']['sinaweibo_pad'])?> <?php if(!$setting['api']['sinaweibo_pad']['open']): ?> disabled="disabled"<?php endif;?> /> 开启</label>
                <label><input type="radio" name="config[login][pad][sinaweibo_pad]" value="0"<?=form_element::checked(!$setting['login']['pad']['sinaweibo_pad'])?> /> 关闭</label>
            </td>
        </tr>
    </table>
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
