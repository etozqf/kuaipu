...
<div class="mar_l_8 mar_r_8" style="width: 900px;">
    ...
    <div class="table_foot">
        ...
        <p class="f_l">
            ...
            <input type="button" onclick="MobileCategory.privs();" value="批量权限" class="button_style_1"/>
        </p>
    </div>
</div>
...
$(function() {
    ...
    window.MobileCategory = {
        ...
        privs:function(catid) {
            if (!catid) {
                catid = tableApp.checkedIds();
                catid = catid.join(',');
            }
            ct.iframe({
                url: '?app=mobile&controller=setting&action=category_privs&catid='+catid,
                width: 350,
                height: 300
            });
            return false;
