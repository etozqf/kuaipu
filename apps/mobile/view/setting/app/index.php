...
<div class="tag_1">
    <ul id="tag-list" class="tag_list">
        ...
        <li data-type="<?php echo $item['type'];?>" data-version="<?php echo $item['version'];?>" data-model="<?=$item['model']?>">
...
<div class="mar_l_8 mar_r_8" style="width: 900px;">
    <div class="app-row">
        <div class="app-row-title drawer" style="display: none;">主导航应用：</div>
        <div class="app-row-title bar" style="display: none;">底部导航：</div>
        <div id="list-menu" class="app-row-list"></div>
    </div>
    <div class="app-row">
        <div class="app-row-title drawer" style="display: none;">应用广场：</div>
        <div class="app-row-title bar" style="display: none;">发现：</div>
