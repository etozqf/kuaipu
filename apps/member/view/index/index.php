...
var row_template  ='<tr id="row_{userid}">';
	...
	row_template +='	<td style="overflow: hidden;"><a href="javascript:url.member({userid});">{username}</a></td>';
	row_template +='	<td style="overflow: hidden;"><a href="javascript:void(0);" onclick="member.sendmail({userid}); return false;" >{email}</a></td>';
